...
export const TokenSelector: React.FC<TokenSelectorProps> = ({ onClose, setToken }) => {
  return (
          ...
          <div className="inner">
            <div className="select-token-wrap">
              <div className="currency-list-wrap">
                <div className="lists">
                  <button type="button" className="currency-label" onClick={() => { setToken('CTC'); onClose() }}>
                  ...
                  <button type="button" className="currency-label" onClick={() => { setToken('USDC'); onClose() }}>
                  ...
                  <button type="button" className="currency-label" onClick={() => { setToken('USDT'); onClose() }}>
                  ...
                  <button type="button" className="currency-label" onClick={() => { setToken('WCTC'); onClose() }}>
